...
#Downloaded from Jackson Labs July 27, 2023
...
setwd("/Users/hagenaue/Documents")

#Reading in the ortholog database:
HOM_AllOrganism<-read.delim("HOM_AllOrganism.txt", sep="\t", header=TRUE, stringsAsFactors = FALSE)
...
str(HOM_MouseVsRat)
#'data.frame':	24569 obs. of  23 variables:
...
write.csv(HOM_MouseVsRat, "HOM_MouseVsRat.csv")
...
#'data.frame':	22659 obs. of  23 variables:
...
#'data.frame':	17246 obs. of  23 variables:
...
write.csv(MouseVsRat_NCBI_Entrez, "MouseVsRat_NCBI_Entrez_JacksonLab_20230727.csv")
