...
# [1] "metaOutputFDR:"
# num [1:13214, 1:7] 0.0322 0.0155 0.0559 0.011 -0.0345 ...
# - attr(*, "dimnames")=List of 2
# ..$ : chr [1:13214] "A1bg" "A3galt2" "A4galt" "Aaas" ...
# ..$ : chr [1:7] "Log2FC_estimate" "SE" "pval" "CI_lb" ...
# NULL
...
# Log2FC_estimate          SE         pval       CI_lb       CI_ub Number_Of_Comparisons
# Wdr7         0.03784478 0.002472598 7.006990e-53  0.03299858  0.04269099                     8
# Txnrd1      -0.09517325 0.007201072 7.043107e-40 -0.10928709 -0.08105941                     9
# Pla2g5       0.15662222 0.012176186 7.270449e-38  0.13275733  0.18048710                     9
# Gli3        -0.07796190 0.007216871 3.341242e-27 -0.09210670 -0.06381709                     9
# Ntng1       -0.14519386 0.013509691 6.096504e-27 -0.17167237 -0.11871535                     8
# Poldip2      0.04267912 0.004190824 2.338821e-24  0.03446526  0.05089299                     8
# FDR
# Wdr7    9.259037e-49
# Txnrd1  4.653381e-36
# Pla2g5  3.202390e-34
# Gli3    1.103779e-23
# Ntng1   1.611184e-23
# Poldip2 5.150864e-21                  11 1.469001e-23
...
# [1] "Wdr7"      "Txnrd1"    "Pla2g5"    "Gli3"      "Ntng1"     "Poldip2"   "Pin1"      "Krtap19-5"
# [9] "Ing2"      "Gins4"     "Tfe3"      "Fis1"      "Rpl18"     "Smarca1"   "Ago4"      "Dlg5"     
# [17] "Sidt1"     "Kcnip4"    "Ppm1a"     "Uck2"      "Agl"       "Rps6"      "Rpusd4"    "Rnf115"   
# [25] "Fam228a"   "Ndfip1"    "Fbxo27"    "Nsmce3"    "Numa1"     "Rdh13"     "Panx2"     "Gne"      
# [33] "Cck"       "Abcb4"     "Chst10"    "Myom3"     "Mpzl1"     "Avpi1"     "Eogt"      "Mavs"     
# [41] "Rnf38"     "Cd3e"      "Nfyb"      "Ndufb10"   "Extl3"     "Fgf1"      "Aplp2"     "Me1"      
# [49] "Cacna2d1"  "Nono"      "Gpr85"     "Rab11b"    "Zfp697"    "Borcs8"    "Jmjd6"     "Ddx21"    
# [57] "Srm"       "Wrap53"    "Parl"      "Blvrb"     "Tubb4b"    "Trappc2l"  "Map7d1"    "Plpp4"    
# [65] "Sphk2"     "Tnfrsf18"  "C1qtnf7"   "Oard1"     "Nub1"      "Mtarc2"    "Upk1a"     "Pkd1"     
# [73] "Pyurf"     "Nlgn2"     "Rpap3"     "Zbtb42"    "Rapgef4"   "Atp6v1h"   "Rhpn2"     "Rbks"     
# [81] "Nrxn2"     "Cnrip1"    "Begain"    "Scaf11"    "Stat2"     "Twist1"    "Mterf4"    "Zpr1"     
# [89] "Tnnt1"     "Dnaaf4"    "Med4"      "Tmem178b"  "Nsmf"      "Cxcl14"    "Actr1b"    "Rtcb"     
# [97] "Hyal2"     "Ctsl"      "Lmbrd1"    "Mrpl48"      
...
MakeForestPlots("Wdr7") 
MakeForestPlots("Txnrd1") #completely unbelievable - still driven by that one CMS dataset.
MakeForestPlots("Pla2g5")
MakeForestPlots("Gli3")
MakeForestPlots("Ntng1")
MakeForestPlots("Poldip2")
MakeForestPlots("Pin1") #there seems to be a pattern that the 4 comparisons/datasets near the top tend to show different results than the ones near the bottom (DG vs. HC?)
